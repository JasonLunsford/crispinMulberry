...
(function ( $ ) {
	$.fn.natCarousel = function( options ) {
		...
		var $largeImageCollection 	= $(".largePictureBox").find("img");
		var $smallImageCollection 	= $(".smallPictureRow").find("img");
		
		var widthOfLargeImage 		= $largeImageCollection.width();
		...
		// Prepare film strip element that contains the large images
		$largeImageCollection.each(function() {
			var $this = $( this );
